...
namespace Core.Utilities.Business
{
    public class BusinessRules
    {
        ...
        public static IResult Run(params IResult[] logigcs)
            //params verdiğim zaman Run metodu içerisine istediğim kadar parametre olarak IResult verebiliyorum.
            //Gönderdiğimiz bütün parametreleri array haline getirip logics'e atanıyor.
        {
